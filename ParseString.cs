...
namespace WillowTree
{
    ...
    {
        public delegate bool ParseBool_ErrorHandler(string str);
        ...
        public static bool AsBool(string str)
        {
            bool outvalue;
        ...
        public static bool AsBool(string str, bool defaultvalue)
        {
            bool outvalue;
            if (bool.TryParse(str, out outvalue))
                return outvalue;
        ...
        public static bool AsBool(string str, ParseBool_ErrorHandler errhandler)
        {
            bool outvalue;
            if (bool.TryParse(str, out outvalue))
                return outvalue;
